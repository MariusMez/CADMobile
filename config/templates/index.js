...
mod.run(($templateCache) => {
    // customPosts
    $templateCache.put('customPosts/ai1ec_event/item.html', require('!html!./customPosts/ai1ec_event/item.html'));
    $templateCache.put('customPosts/ai1ec_event/list.html', require('!html!./customPosts/ai1ec_event/list.html'));
	$templateCache.put('customPosts/monaco-informativo/item.html', require('!html!./customPosts/monaco-informativo/item.html'));
    $templateCache.put('customPosts/monaco-informativo/list.html', require('!html!./customPosts/monaco-informativo/list.html'));
